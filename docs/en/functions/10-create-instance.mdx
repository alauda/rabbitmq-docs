...
<Directive type="tip" title="Version Suggestion">
  ...
  1. `4.2` includes newer community fixes and ongoing feature evolution.
  2. If you are running `3.12`, plan and validate migration to `4.2` according to your business window.
</Directive>
