...
This article covers the basic operations within the Management UI (Management Interface). For more content, please refer to the [RabbitMQ Official Documentation](https://www.rabbitmq.com/docs/management).

## Obtaining the Management UI Access Address
...
<Tabs>
  <Tab label="Web Console">
    ...
    4. Click the link provided in the **Port** column to log into the Management UI in a new browser tab.
  </Tab>
</Tabs>
...
After logging into the Management UI, the page appears as shown in the figure below:
